...
elseif($msg=="fail"){
    ...
    ?>
        ...
        <div class="innerdiv">
            ...
            <div><label>Branch:</label><input type="radio" name="branch" value="other"/>Other<input type="radio" name="branch" value="Madhabdi"/>Madhabdi<div style="margin-left:80px"><input type="radio" name="branch" value="Badda"/>Badda<input type="radio" name="branch" value="Dhanmondi"/>Dhanmondi</div>
            </div>   
